...
describe("Plan Schema", () => {
  ...
  describe("formatPlanSummary", () => {
    it("生成中文摘要", () => {
      const plan = createPlan("写一�?Web 应用", [
      ...
      expect(summary).toContain("写一�?Web 应用");
